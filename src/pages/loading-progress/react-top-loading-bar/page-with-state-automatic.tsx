        ...
        >
          ...
          <article className="mt-5">
            ...
            >
              <li>
                <Link
                  href="/loading-progress/react-top-loading-bar/page-with-state-automatic?page=1&color=red"
                  className="text-blue-700 dark:text-blue-300 hover:underline hover:text-blue-600 focus:text-blue-600 dark:hover:text-yellow-200 dark:focus:text-yellow-200"
                >
                  State (Page 1)
                </Link>
              ...
              <li>
                <Link
                  href="/loading-progress/react-top-loading-bar/page-with-state-automatic?page=2&color=yellow"
                  className="text-blue-700 dark:text-blue-300 hover:underline hover:text-blue-600 focus:text-blue-600 dark:hover:text-yellow-200 dark:focus:text-yellow-200"
                >
                  State (Page 2)
                </Link>
