...
import TextMenuEditorWithTaskList from "../../modules/tiptap/components/TextMenuEditorWithTaskList";

export default function TiptapPage() {
  return (
    <div className="flex flex-col h-screen">
      <Header
        title="Tiptap (TaskList)"
        description="Enables you to use task lists in the editor."
      />
